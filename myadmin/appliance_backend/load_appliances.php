<?php 
include "../../config.php";
$query = "SELECT * FROM appliances ORDER BY appliance_id DESC;";
$output = "";
...
while($row = mysqli_fetch_assoc($result)){
    ...
    <div class="_card_img">
    <img src="../uploads/appliances_images/'.$row['appliance_image'].'" alt="'.$row['appliance_name'].'">
    </div>
    <div class="card-info">
        <h3>'.$row['appliance_name'].'</h3>
    </div>
    <div class="_delete_btn" data-id="'.$row['appliance_id'].'">
