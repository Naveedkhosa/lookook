...
if ($result = mysqli_query($conn, $sql)) {
  if (mysqli_num_rows($result) > 0) {
    ...
    echo "<script>
     alert('bartender Service is not available currently.');
...
<head>
  ...
  <title>Book a bartender | Look My Cook</title>
...
<body>
    ...
    <div class="pre_bk_kart_page">
      ...
      <!-- selection box -->
       ...
       <a onclick="openModal('modal5')" class="pre_bk_slect_sec">
        <p class="para_p">Number of bartenders</p>
        <div class="pre_bk_box">
          <p class="para_h_" id="number_of_workers">Select number of bartenders</p>
          <i class="fa-solid fa-chevron-down"></i>
        </div>
      </a>
      <!-- selection box -->
  ...
  <div id="modal5" class="modal">
    <div class="popup1">
      <p class="heading_p">Number of bartenders</p>
      <div class="close"><svg width="20" height="20" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
          <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
        </svg></div>
      <div class="content1">
        <p class="para_p">How many number of bartenders you need?</p>
        <div class="increase_decrease_container">

          <!-- dishes box -->
          <div class="increase_decrease_box">
            <div class="incre_decre_contnt">
              <p class="para_h">Bartenders</p>
  ...
  <script src="static/js/bartender.js"></script>
