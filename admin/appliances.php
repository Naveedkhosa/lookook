...
<head>
    ...
    <title>Appliances | Look My Cook</title>
...
<body>
    ...
    <div class="_appliance_add_btn">
        <div class="_add_appliance" id="add_appliance_btn">Add New Appliance</div>
    </div>
    ...
    $(document).ready(function() {
        ...
        function __load_appliances() {
            $.ajax({
                url: 'appliance_backend/load_appliances',
                type: 'POST',
        ...
        $(document).on("click", "._delete_btn", function() {
            ...
            $.ajax({
                type: 'POST',
                url: 'appliance_backend/delete_appliance',
                data: {
                    id: id
                },
